...
function Arrow(bc){  
  ...
  this.startEl.style.backgroundColor ="#aaaa00";
  ...
  this.endEl.style.backgroundColor ="#ff0000";
  ...
  this.startImg.style.width = "10px";
  this.startImg.style.height = "10px";  
  this.startImg.style.position="absolute";
  this.startImg.src = "resources/resize.png";    
  ...
  this.refresh = function (){ 
    if (this.startIb != null) {
	 ...
	 // setInfo( "startDir:"+this.startDir+ "endDir:"+this.endDir);	    	    	   
	  
	  
	
	  /*	 
	  jetzt sind alle seiten des pfeiles vorgerechnet. in einer klassenvariavlen stehen die seitenberechnug.
	  
	  diese seitenberechnung wird nach jeder ib-positionsverschiebung(und resize) neu berechnet und anschließend von ib refresh arrow prozedur 
	  die jeweilige position zugewiesen - ende !
	  */
  ...
  this.refreshPos = function (){ 
   ...
   //display none!! einfügen
		...
		this.startImg.style.left = this.endX+width/2;
		...
		//this.startImg.style.left = this.startX;
		//this.startImg.style.top = this.endY + height/2;		
